<template>
  	<div class="zlbox">
		<el-alert
			title="* 注：若发现备考资料领取地址过期情况，请联系管理员处理。"
			type="warning"
			close-text="知道了">
			<el-button type="primary" size="small" onclick="NTKF.im_openInPageChat('kf_10353_1540968057431')" icon="el-icon-service">在线客服</el-button>
		</el-alert>
